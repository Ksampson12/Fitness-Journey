...
import { Flame, Trophy, Calendar, Target, TrendingUp, ChevronDown } from "lucide-react";
              ...
              <Card className="border-white/10 bg-card/50">
                ...
                <CardContent className="space-y-2">
                  {weeklyPlan.schedule.map((day: any, i: number) => (
                    <Collapsible key={i}>
                      <CollapsibleTrigger className="w-full" data-testid={`dropdown-day-${i}`}>
                        <div className="flex items-center gap-4 py-3 px-2 rounded-lg hover-elevate cursor-pointer">
                      ...
                      <CollapsibleContent>
                        <div className="ml-12 pb-3 space-y-2">
                          {day.exercises && day.exercises.length > 0 ? (
                            day.exercises.map((exercise: any, j: number) => (
                              <div key={j} className="flex items-start gap-3 py-1.5 text-sm border-l-2 border-primary/30 pl-3">
                            ...
                            <div className="text-xs text-muted-foreground italic">Rest day - no exercises</div>
                          )}
                        </div>
                      </CollapsibleContent>
                    </Collapsible>
