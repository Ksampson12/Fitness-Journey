...
export function Navigation() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-50 glass-panel border-t border-white/5 fixed-bottom-safe">
      <div className="flex justify-around items-center h-16 max-w-md mx-auto px-4 safe-area-x">
        {links.map((link) => {
